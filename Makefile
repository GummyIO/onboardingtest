...
# Deploy target
deploy:
	forge script script/DeployGummyERC20T.s.sol:DeployGummyERC20T --private-key $(PRIVATE_KEY) --rpc-url $(GOERLI_RPC_URL) --broadcast --verify -vvvv
...
slither :; python3 -m slither . --config-file slither.config.json --checklist 
